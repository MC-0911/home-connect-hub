  ...
  return <div className="space-y-4">
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {someSelected && <Badge variant="secondary" className="whitespace-nowrap bg-primary/10 text-primary">
          ...
          {someSelected && <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={() => setBulkSuspendDialogOpen(true)} className="text-destructive">
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-popover">
                        <DropdownMenuItem onClick={() => handleSelectOne(user.id, !selectedIds.has(user.id))} className="flex items-center gap-2 cursor-pointer">
                        ...
                        <DropdownMenuItem onClick={() => setSelectedUser(user)} className="flex items-center gap-2 cursor-pointer">
                          <Eye className="h-4 w-4" />
                          View Details
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        {user.is_admin ? <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <DropdownMenuItem className="flex items-center gap-2 cursor-pointer text-amber-600" onSelect={e => e.preventDefault()}>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction onClick={() => removeAdminRole(user)} className="bg-amber-600 hover:bg-amber-700">
                                  Remove Admin
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
                            ...
                            <AlertDialogTrigger asChild>
                              <DropdownMenuItem className="flex items-center gap-2 cursor-pointer text-primary" onSelect={e => e.preventDefault()}>
                                <Shield className="h-4 w-4" />
                                Make Admin
                              </DropdownMenuItem>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => assignAdminRole(user)}>
                                  Make Admin
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
                        ...
                        <DropdownMenuSeparator />
                        {user.is_suspended ? <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <DropdownMenuItem className="flex items-center gap-2 cursor-pointer text-green-600" onSelect={e => e.preventDefault()}>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => toggleSuspension(user, false)} className="bg-green-600 hover:bg-green-700">
                                  Unsuspend
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
                            ...
                            <AlertDialogTrigger asChild>
                              <DropdownMenuItem className="flex items-center gap-2 cursor-pointer text-destructive" onSelect={e => e.preventDefault()}>
                            ...
                            <AlertDialogContent>
                              ...
                              <div className="py-4">
                                <Textarea placeholder="Reason for suspension (optional)" value={suspensionReason} onChange={e => setSuspensionReason(e.target.value)} className="min-h-[80px]" />
                              </div>
                              <AlertDialogFooter>
                                <AlertDialogCancel onClick={() => setSuspensionReason('')}>
                                  Cancel
                                </AlertDialogCancel>
                                <AlertDialogAction onClick={() => toggleSuspension(user, true, suspensionReason)} className="bg-destructive hover:bg-destructive/90">
                                  Suspend User
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
      ...
      <AlertDialog open={bulkSuspendDialogOpen} onOpenChange={setBulkSuspendDialogOpen}>
        <AlertDialogContent>
          ...
          <div className="py-4">
            <Textarea placeholder="Reason for suspension (optional)" value={bulkSuspensionReason} onChange={e => setBulkSuspensionReason(e.target.value)} className="min-h-[80px]" />
          </div>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setBulkSuspensionReason('')}>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleBulkSuspend} className="bg-destructive hover:bg-destructive/90">
              Suspend All
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      ...
      <AlertDialog open={bulkUnsuspendDialogOpen} onOpenChange={setBulkUnsuspendDialogOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleBulkUnsuspend} className="bg-green-600 hover:bg-green-700">
              Unsuspend All
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
          ...
          {selectedUser && <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {selectedUser.is_suspended ? <Badge variant="destructive" className="mt-1">Suspended</Badge> : <Badge variant="secondary" className="mt-1 bg-green-500/10 text-green-600">Active</Badge>}
                </div>
              </div>

              <div className="space-y-3">
                {selectedUser.phone && <div className="flex items-center gap-3 text-sm">
                    <Phone className="h-4 w-4 text-muted-foreground" />
                    <span>{selectedUser.phone}</span>
                  </div>}
                {selectedUser.location && <div className="flex items-center gap-3 text-sm">
              ...
              {selectedUser.is_suspended && selectedUser.suspension_reason && <div className="p-3 rounded-lg bg-destructive/10 border border-destructive/20">
                  ...
                  {selectedUser.suspended_at && <p className="text-xs text-destructive/60 mt-2">
