      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="p-3 rounded-lg bg-primary-foreground">
            <p className="text-xs text-primary">List Price</p>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input type="text" value={offerAmount} onChange={e => setOfferAmount(e.target.value.replace(/[^0-9,]/g, ""))} className="pl-9" placeholder="Enter amount" />
            </div>
            {!isNaN(priceDiff) && <p className={`text-xs ${priceDiff >= 0 ? "text-green-500" : "text-yellow-500"}`}>
          ...
          <div className="space-y-2">
            ...
            <Textarea placeholder="Why should the seller accept your offer?" value={message} onChange={e => setMessage(e.target.value)} rows={3} />
          </div>

          <Button onClick={handleSubmit} disabled={!offerAmount || loading} className="w-full">
