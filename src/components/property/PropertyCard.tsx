        ...
        <div className="bg-card rounded-xl overflow-hidden shadow-elegant hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            <div className="absolute top-4 left-4 flex gap-2">
              {property.featured && <Badge className="bg-accent text-accent-foreground border-0">
                  Featured
                </Badge>}
            ...
            setIsFavorite(!isFavorite);
              ...
              <Heart className={cn("w-5 h-5 transition-colors", isFavorite ? "fill-destructive text-destructive" : "text-muted-foreground")} />
            </button>
          ...
          <div className="p-5 flex flex-col h-[200px]">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-sm mb-4">
              ...
              <span className="line-clamp-1 text-sm text-secondary">
