...
import { Check, Home, MapPin, Ruler, Trees, Building2, ImageIcon, Mountain } from 'lucide-react';
...
const regularSteps = [
  ...
  { label: 'Interior', icon: Ruler },
  { label: 'Exterior', icon: Trees },
  { label: 'Neighborhood', icon: Building2 },
...
const landSteps = [
  { label: 'Basic Info', icon: Home },
  { label: 'Location', icon: MapPin },
  { label: 'Land Features', icon: Mountain },
  { label: 'Photos', icon: ImageIcon }
];
...
const StepIndicator = ({
  ...
  const steps = isLandProperty ? landSteps : regularSteps;
