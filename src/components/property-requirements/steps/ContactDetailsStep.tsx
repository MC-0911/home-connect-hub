      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <Select value={formData.moveTimeline} onValueChange={value => updateFormData({
            moveTimeline: value
          })}>
              ...
              <SelectContent className="bg-popover">
                {timelineOptions.map(option => <SelectItem key={option.value} value={option.value}>
                    {option.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="space-y-3">
            ...
            <Select value={formData.currentSituation} onValueChange={value => updateFormData({
            currentSituation: value
              ...
              <SelectContent className="bg-popover">
                {situationOptions.map(option => <SelectItem key={option.value} value={option.value}>
                    {option.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="fullName" placeholder="John Doe" value={formData.fullName} onChange={e => updateFormData({
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="john@example.com" value={formData.email} onChange={e => updateFormData({
            ...
            <div className="space-y-2">
              ...
              <Input id="phone" type="tel" placeholder="+1 (555) 123-4567" value={formData.phone} onChange={e => updateFormData({
        ...
        <div className="space-y-3">
          ...
          <RadioGroup value={formData.preferredContactMethod} onValueChange={(value: 'email' | 'phone' | 'whatsapp') => updateFormData({
        ...
        <div className="flex items-start space-x-3 p-4 rounded-lg bg-sky-50">
          <Checkbox id="marketingConsent" checked={formData.marketingConsent} onCheckedChange={checked => updateFormData({
