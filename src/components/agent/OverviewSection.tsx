import { Building2, Users, TrendingUp, DollarSign, Plus, Home, Tag, Clock, Eye, Edit, BarChart3, MessageSquare, Trash2, X, CalendarIcon, Pencil, MoreVertical, Wrench, Mail, Phone } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <MaintenanceRequestsCard onNavigate={onNavigate} />
      </div>
    </div>
  );
}
