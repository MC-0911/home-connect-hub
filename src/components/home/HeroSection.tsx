      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="bg-card rounded-full p-2 shadow-lg max-w-5xl mx-auto border border-border"
          >
            <div className="flex flex-col md:flex-row items-center gap-2">
              ...
              <div className="relative flex-1 w-full md:w-auto">
                <Input
                  ...
                  className="h-11 border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 pl-4"
                  value={minPrice}
              ...
              <Button
                variant="gold"
                size="lg"
                className="h-11 px-6 rounded-full shrink-0"
