...
const sellerBenefits = [
  ...
  "Reach real buyers instantly",
  "Get real-time views, no middlemen",
  "Secure transactions & support",
];

const sellerStats = [
  { icon: TrendingUp, value: "30%", label: "Price Drop" },
  { icon: DollarSign, value: "$0", label: "Listing Fee" },
  { icon: Users, value: "10K+", label: "Sell Requests" },
];
