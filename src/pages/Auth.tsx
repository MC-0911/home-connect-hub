...
export default function Auth() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.info(
      "Authentication requires Lovable Cloud. Please enable it in your project settings to continue.",
      { duration: 5000 }
    );
  };
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button variant="gold" className="w-full h-12" type="submit">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="h-12" onClick={() => toast.info("Social login requires Lovable Cloud")}>
